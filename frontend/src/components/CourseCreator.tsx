...
import { generateDynamicQuiz, generateDynamicFlashcards, generateEnhancedNotes, generateCourseLessons } from '../utils/quizGenerator';
...
const CourseCreator: React.FC<CourseCreatorProps> = ({ onCourseCreated }) => {
  ...
  const handleCreateCourse = async () => {
    ...
    try {
      ...
      const lessons = generateCourseLessons(title, activeTab, file?.name, url, courseTimestamp);
      ...
      const newCourse: Course = {
        ...
        fileName: activeTab === 'pdf' ? file?.name : undefined,
        createdAt: new Date(),
        duration: '45-60 min',
        ...
        level: 'Intermediate',
        category: notes[0]?.topics[0] || 'General',
