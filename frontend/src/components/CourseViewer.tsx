...
import { ArrowLeft, BookOpen, HelpCircle, Layers, MessageSquare, Download, CheckCircle, Play, Clock, Users, Star, Award, FileText, Link, Code, Image } from 'lucide-react';
...
const CourseViewer: React.FC<CourseViewerProps> = ({ course, onBack, onUpdateCourse }) => {
  ...
  const handleQuizComplete = async (score: number) => {
    ...
    try {
      await coursesAPI.update(course.id, { progress: updatedCourse.progress });
    } catch (error) {
